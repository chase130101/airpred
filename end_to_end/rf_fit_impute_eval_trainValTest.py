...
train1_x_imp, train1_r2_scores = rf_imputer.transform(train1_x, evaluate = True, backup_impute_strategy = 'mean')
train2_x_imp, train2_r2_scores = rf_imputer.transform(train2_x, evaluate = True, backup_impute_strategy = 'mean')
val_x_imp, val_r2_scores = rf_imputer.transform(val_x, evaluate = True, backup_impute_strategy = 'mean')
test_x_imp, test_r2_scores = rf_imputer.transform(test_x, evaluate = True, backup_impute_strategy = 'mean')
