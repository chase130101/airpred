"""Description: This script allows the user to train CNN1 from CNN_architecture.py
...
pickle.dump(cnn, open('cnn1_final_ridgeVImp.pkl', 'wb'))
test.to_csv('../data/test_cnn1Pred_ridgeVImp.csv', index=False)