...
parameter_grid_rf = {'max_features' : [10, 15, 20, 25, 30]}
cv_r2, best_hyperparams = cross_validation(data=train, model=rf, hyperparam_dict=parameter_grid_rf, num_folds=5, y_var_name='MonitorData', site_var_name='site')
