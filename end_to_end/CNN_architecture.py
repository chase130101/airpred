...
class CNN(torch.nn.Module):
    def __init__(self, input_size_conv, hidden_size_conv, kernel_size, padding, input_size_full, hidden_size_full, hidden_size_combo):
        ...
        # convolutional layer for non-constant input variables within a site sequence; normalize output before ReLU
        ...
        # linear layer for all input variables; normalize output before ReLU
