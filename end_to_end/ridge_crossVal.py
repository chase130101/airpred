...
parameter_grid_ridge = {'alpha' : [1, 0.1, 0.01, 0.001, 0.0001, 0.00001]}
cv_r2, best_hyperparams = cross_validation(data=train, model=ridge, hyperparam_dict=parameter_grid_ridge, num_folds=5, y_var_name='MonitorData', site_var_name='site')
