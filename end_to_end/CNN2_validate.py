"""Description: This script allows the user to tune the CNN2 model in 
CNN_architecture.py using imputed train and validation sets. The 
best hyper-parameters from validation will be outputted for the user to see.
"""
import pandas as pd
import numpy as np
import torch
...
# this imported class is the CNN2 architecture (see CNN_architecture.py)
