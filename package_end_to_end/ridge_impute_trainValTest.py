...
config_section = "Ridge_Train_Test_Val_Imputation"
...
val_x_imp = ridge_imputer.transform(val_x)
...
val_imp_df.to_csv(config[config_section]["val_imputed_ridge_path"], index = False)
test_imp_df.to_csv(config[config_section]["test_imputed_ridge_path"], index = False)
pickle.dump(ridge_imputer, open(config[config_section]["rf_impute_model"], 'wb'))